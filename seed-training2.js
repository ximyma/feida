// Seed training data into the CORRECT database used by standalone.js
const db = require('better-sqlite3')('C:/Users/ximym/.qclaw/workspace/data/ehr.db');
...
const scoreValues = [85, 90, 78, 92, 88, 76, 95, 83, 91, 87];
let recordCount = 0;
employees.forEach((emp, i) => {
  const ci = i % 5;
  const score = scoreValues[i % scoreValues.length];
...
db.close();
console.log('\nDone! All training data seeded into workspace DB.');
